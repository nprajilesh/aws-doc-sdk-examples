...
def get_parameter(parameter_name, with_decryption):
    ...
    :param with_decryption: return decrypted value for secured string params, ignored for String and StringList parameter types
...
def get_parameters(parameter_names, with_decryption):
    ...
    :param parameter_names: Name of the parameter to create in AWS SSM
    :param with_decryption: return decrypted value for secured string params, ignored for String and StringList parameter types
    :return: Return parameter details if exist else None
    """
    ssm_client = boto3.client('ssm')
