...
def put_parameter_with_overwite(parameter_name, parameter_value, parameter_type):
    """Creates new parameter in AWS SSM
...
def main():
    ...
    result = put_parameter_with_overwite(parameter_name, parameter_value, parameter_type)
    logging.info(result)
